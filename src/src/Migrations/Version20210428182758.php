 ...
 */
final class Version20210428182758 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE catalogage (id INT AUTO_INCREMENT NOT NULL, catalogue_id INT NOT NULL, oeuvre_id INT NOT NULL, number INT NOT NULL, INDEX IDX_B4DB37E4A7843DC (catalogue_id), UNIQUE INDEX UNIQ_B4DB37E88194DE8 (oeuvre_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE catalogue (id INT AUTO_INCREMENT NOT NULL, composer_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, curator VARCHAR(255) NOT NULL, organization_method VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_59A699F57A8D2620 (composer_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE composer (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, birth_date DATE DEFAULT NULL, death_date DATE DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE oeuvre (id INT AUTO_INCREMENT NOT NULL, composer_id INT NOT NULL, ensemble_id INT NOT NULL, name VARCHAR(255) NOT NULL, opus INT DEFAULT NULL, tonality VARCHAR(255) DEFAULT NULL, genre VARCHAR(255) DEFAULT NULL, INDEX IDX_35FE2EFE7A8D2620 (composer_id), INDEX IDX_35FE2EFEB268ECB1 (ensemble_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE catalogage ADD CONSTRAINT FK_B4DB37E4A7843DC FOREIGN KEY (catalogue_id) REFERENCES catalogue (id)');
        $this->addSql('ALTER TABLE catalogage ADD CONSTRAINT FK_B4DB37E88194DE8 FOREIGN KEY (oeuvre_id) REFERENCES oeuvre (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE catalogage DROP FOREIGN KEY FK_B4DB37E4A7843DC');
        ...
        $this->addSql('ALTER TABLE catalogage DROP FOREIGN KEY FK_B4DB37E88194DE8');
        ...
        $this->addSql('DROP TABLE catalogage');
